...
<head>
    ...
    <title>Guest List - Herbel Apartelle Reservation</title>
...
<body>
    ...
    <nav class="main-nav">
        <a href="homepage.php" class="active">Guest List</a>
                            ...
                            <tr id="res-row-<?php echo $row['Reservation_ID']; ?>" data-guest-name="<?php echo htmlspecialchars($row['First_Name'] . ' ' . $row['Last_Name']); ?>" data-checkout="<?php echo htmlspecialchars($row['Check_out_Date']); ?>" data-status="<?php echo htmlspecialchars($row['Reservation_Status']); ?>">
                                ...
                                <td class="actions-cell">
                                    <?php if ($row['Reservation_Status'] == 'Reserved'): ?>
                                        <button class="action-btn check-in-btn" data-id="<?php echo $row['Reservation_ID']; ?>" data-status="check-in"><i class="fas fa-sign-in-alt"></i> Check-in</button>
                                    <?php elseif ($row['Reservation_Status'] == 'Checked-In'): ?>
                                        <button class="action-btn check-out-btn" data-id="<?php echo $row['Reservation_ID']; ?>" data-status="check-out"><i class="fas fa-sign-out-alt"></i> Check-out</button>
                                    <?php else: ?>
                                        <span>--</span>
                                    <?php endif; ?>
                                </td>
        ...
        <aside class="sidebar available-rooms-sidebar">
            ...
            <div class="sidebar-content-wrapper">
                <div class="room-panel">
                    ...
                    <ul class="rooms-status-list">
                        <?php if ($available_rooms_result && $available_rooms_result->num_rows > 0): ?>
                            <?php mysqli_data_seek($available_rooms_result, 0); ?>
                ...
                <div class="room-panel">
                    ...
                    <ul class="rooms-status-list">
                        <?php if ($occupied_rooms_result && $occupied_rooms_result->num_rows > 0): ?>
                            <?php mysqli_data_seek($occupied_rooms_result, 0); ?>
                    ...
                    <div class="form-column">
                        ...
                        <fieldset>
                            ...
                            <div class="duration-buttons">
                                ...
                                <button type="button" data-duration="48">2 Days</button>
                                <button type="button" data-duration="72">3 Days</button>
                                <button type="button" data-duration="168">1 Week</button>
                            </div>
    ...
    <div id="checkOutConfirmModal" class="modal-overlay">
        <div class="modal-content confirm-modal">
            ...
            <div class="confirm-actions">
                <button type="button" class="action-btn cancel-btn" id="cancelCheckOut">Cancel</button>
